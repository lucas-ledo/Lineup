...
export function TransferMarket({
  ...
  return <section className="transfer-panel">
    ...
    {isOpen && <div className="market-body">
      ...
      <div className="market-results">{players.length > 0 ? <div className="market-players">{players.map((player) => {
      ...
      })}</div> : <div className="market-empty"><span>↗</span><strong>Explora el mercado</strong><p>Busca un jugador o abre la plantilla de otro club.</p></div>}</div>
    </div>}
  </section>
}
